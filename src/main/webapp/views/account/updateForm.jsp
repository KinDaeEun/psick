...
<body>
	<form action="update.hu?ano=${account.ano}" method="post">
		<div class="board_write_wrap">
			<div class="inner">
				<div class="board_write_title">수정</div>
				<div class="board_writebox_cover">
					<div class="board_writebox">
								...
								<dl>
									...
									<dd>
										<input type="text" name="a_title" class="form-control"
											placeholder="제목 입력" autofocus="autofocus" required="required"
											value="${account.a_title}">
									</dd>
								</dl>
							</div>
								...
								<dl>
									...
									<dd>
										<input type="text" name="a_name" class="form-control"
											placeholder="글쓴이 입력" required="required"
											value="${account.a_name}">
									</dd>
								</dl>
							</div>
						</div>
						<textarea id="summernote" name="a_content">${account.a_content}</textarea>
						<div class="board_write_button">
							...
							<input type="button" value="취소" class="btn_style db"
								onclick="location.href='list.hu?num=0&pageNum=1'">
						</div>
					</div>
				</div>
			</div>
